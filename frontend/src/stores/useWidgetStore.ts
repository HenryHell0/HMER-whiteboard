...
export const useWidgetStore = defineStore('widgets', () => {
	...
	function getWidgetById(id: string): Widget { // this returns a full widget (expression or graph, not just flat widgetdata, so should it return just widgetData or what.)
